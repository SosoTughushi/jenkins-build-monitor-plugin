...
public class ListerTest {
    ...
    private static final String fruitsFormat = "Fruits: %s";
    ...
    public void should_use_an_optional_template_to_describe_a_list_with_multiple_items() throws Exception {
        assertThat(Lister.describe(fruitsFormat, listOf(apple, orange)), is("Fruits: apple and orange"));
    }

    @Test
    public void should_say_when_the_list_has_no_items() throws Exception {
        assertThat(Lister.describe("No fruit for you today :-(", fruitsFormat, listOf()), is("No fruit for you today :-("));
    }

    @Test
    public void should_allow_to_use_a_different_template_to_describe_a_list_with_one_item() throws Exception {
        assertThat(Lister.describe("Empty", "%s fruit", fruitsFormat, listOf(apple)), is("apple fruit"));
    }
